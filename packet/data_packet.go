...
import (
	"encoding/binary"
	"github.com/drizzleaio/socket/utils"
	"io"
)
...
// DataPacket represents a single network message.
...
func (packet *DataPacket) Write(writer io.Writer) error {
...
func (packet *DataPacket) Bytes() []byte {
	...
	result = append(result, utils.Int64ToBytes(packet.Length)...)
